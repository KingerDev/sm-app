...
import { Icons, Photo, coverSrc } from '../components/shell';
...
const OpenedCapsule = ({ capsule: c, onOpen }) => (
    <button className="card flush" onClick={onOpen} style={{
        ...
        <div style={{ position: 'relative' }}>
            <Photo seed={c.seed} url={coverSrc(c)} style={{ height: 110, borderRadius: 0 }} />
            <div style={{
            ...
            {locked ? (
                ...
                <div className="scroll" style={{ flex: 1, paddingTop: 6 }}>
                    <div style={{ position: 'relative', margin: '0 -20px 20px' }}>
                        <Photo seed={c.seed} url={coverSrc(c)} style={{ height: 180, borderRadius: 0 }} />
                    </div>
